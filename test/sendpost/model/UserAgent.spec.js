...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendpost.UserAgent();
  });
  ...
  describe('UserAgent', function() {
    it('should create an instance of UserAgent', function() {
      // uncomment below and update the code to test UserAgent
      //var instance = new sendpost.UserAgent();
      //expect(instance).to.be.a(sendpost.UserAgent);
    });
