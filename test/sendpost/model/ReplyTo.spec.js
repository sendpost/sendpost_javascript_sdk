...
(function(root, factory) {
  ...
  describe('ReplyTo', function() {
    it('should create an instance of ReplyTo', function() {
      // uncomment below and update the code to test ReplyTo
      //var instance = new sendpost.ReplyTo();
      //expect(instance).to.be.a(sendpost.ReplyTo);
    });
