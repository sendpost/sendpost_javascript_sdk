...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendpost.QEmailMessage();
  });
  ...
  describe('QEmailMessage', function() {
    it('should create an instance of QEmailMessage', function() {
      // uncomment below and update the code to test QEmailMessage
      //var instance = new sendpost.QEmailMessage();
      //expect(instance).to.be.a(sendpost.QEmailMessage);
    });
