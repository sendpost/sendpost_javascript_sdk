...
(function(root, factory) {
  ...
  describe('QEvent', function() {
    it('should create an instance of QEvent', function() {
      // uncomment below and update the code to test QEvent
      //var instance = new sendpost.QEvent();
      //expect(instance).to.be.a(sendpost.QEvent);
    });
